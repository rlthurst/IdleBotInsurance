...
## Before Running
    ...
    Check to make sure Google Chrome is running on Version 87.

    If you wish to use the most recent update of Google Chrome or if the program no longer works, check the link below for a patch.
